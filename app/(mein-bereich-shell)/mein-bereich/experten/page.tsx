// app/mein-bereich/experten/page.tsx
"use client";
...
const PLACEHOLDER_CARDS = [
  { label: "Innenarchitektur", text: "Studios und Planer:innen für ganzheitliche Raumkonzepte." },
  { label: "Küchenstudios", text: "Spezialisierte Partner für Küche und Kochen." },
  { label: "Badplanung", text: "Experten für Wellness-Bäder und Funktionsräume." },
  { label: "Handwerk & Ausführung", text: "Handwerksbetriebe aus deiner Region." },
  { label: "Materialberatung", text: "Hersteller und Lieferanten für Oberflächen und Materialien." },
  { label: "Lichtplanung", text: "Lichtgestalter:innen für Atmosphäre und Funktion." },
];
      ...
      <div className="mx-auto max-w-7xl space-y-8">
        ...
        >
          ...
          <p className="max-w-2xl text-sm md:text-[15px] text-slate-600 dark:text-white/60">
            Hier begegnen dir die Menschen, die deine Wohnerlebnisse möglich machen –
            Planer:innen, Handwerker und Studios, mit denen du im Wertschöpfungs-Kreis verbunden bist.
          </p>
        </motion.header>
        ...
        >
          ...
          <div className="space-y-0.5">
            ...
            <p className="text-[12px] text-slate-600 dark:text-white/55 leading-snug">
              Wir bauen gerade das Experten-Netzwerk – damit du Planer:innen, Studios und
              Handwerksbetriebe direkt aus deinem Wirkungsraum heraus finden und verknüpfen kannst.
            </p>
          </div>
        </motion.div>
              ...
              >
                <div className="m-3 flex-1 rounded-xl border border-slate-200 dark:border-white/10 bg-slate-100/80 dark:bg-white/5 px-4 py-3 flex flex-col justify-between">
                  ...
                  <div className="pointer-events-none absolute inset-3 flex items-center justify-center opacity-20">
                    <Users2 className="h-10 w-10 text-slate-400 dark:text-white/30" />
                  </div>
