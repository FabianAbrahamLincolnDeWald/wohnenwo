...
const NAV_ITEMS = [
  { label: "WohnenWo Werte wirken", href: "/wertewirken", current: true },
  { label: "Mehr Ehre", href: "/wertewirken/mehrehre" },
  { label: "Mehr Wert", href: "/wertewirken/mehrwert" },
];

export default function WerteWirkenNavBar() {
