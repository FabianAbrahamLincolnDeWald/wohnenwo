...
function SetupCard({
  ...
  const subtitleSize =
    `${subtitleClassName ?? "md:text-[19px] md:leading-6"} text-[16.2px] leading-[22.22px]`;
  ...
  return (
    <>
      <div
        ...
        style={{ ["--intent-top" as any]: "152px", ["--intent-top-mobile" as any]: "172px" } as React.CSSProperties}
      >
        <div
          role="button"
          tabIndex={0}
