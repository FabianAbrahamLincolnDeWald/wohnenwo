...
export default function Sektor1_EinladungZusammenarbeit() {
  return (
    <section className="relative overflow-hidden bg-white text-slate-900">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 pt-[132px] pb-[66px] sm:pt-28 sm:pb-20 md:pt-32 md:pb-24 text-center">
        <h1 className="font-semibold tracking-tight leading-[1.02] text-[40px] sm:text-[56px] md:text-[80px] lg:text-[96px]">
          ...
          <span className="block">
            ...
            <span className="relative inline-block align-baseline">
              <span className="bg-[linear-gradient(175deg,rgba(51,65,85,1)_0%,rgba(51,65,85,1)_12%,rgba(251,191,36,1)_58%,rgba(253,224,71,1)_100%)] bg-clip-text text-transparent">zu</span>
              <span
                aria-hidden
        ...
        <p className="mt-8 text-[18px] sm:text-[20px] md:text-[22px] font-semibold text-slate-700 mx-auto md:max-w-[56ch] lg:max-w-[58ch] leading-[1.35] md:leading-[1.18]">
          Hier trifft Gestaltung auf Handwerk, und Unternehmer auf Kunde, um gemeinsam zu handeln und zu wirken – ehrlich, offen, menschlich und sinnstiftend. Jeder hat volle Einsicht in Zahlen, Systeme, Absichten und Strukturen. Ein wirtschaftlicher Raum, in dem du dich vertraut fühlst – und in dem das, was dir wichtig ist, sichtbar und geschätzt wird.
        </p>
      </div>
    </section>
  );
