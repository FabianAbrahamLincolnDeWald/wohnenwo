// app/mein-bereich/community/page.tsx
"use client";
...
const PLACEHOLDER_CARDS = [
  { label: "Inspirationskreis", text: "Teile Ideen und lass dich von anderen Wohnerlebnissen inspirieren." },
  { label: "Wirkungsnetzwerk", text: "Verbinde dich mit Menschen, die bewusst investieren und gestalten." },
  { label: "Fragen & Antworten", text: "Stell deine Fragen zu Materialien, Prozessen und Projekten." },
  { label: "Erfahrungsberichte", text: "Ehrliche Einblicke in abgeschlossene Projekte und Wohnkonzepte." },
  { label: "Lokale Kreise", text: "Regionale Gruppen für den Austausch in deiner Stadt." },
  { label: "Events & Treffen", text: "Einladungen zu Showroom-Abenden, Workshops und Hausführungen." },
];
      ...
      <div className="mx-auto max-w-7xl space-y-8">
        ...
        >
          ...
          <p className="max-w-2xl text-sm md:text-[15px] text-slate-600 dark:text-white/60">
            Hier entsteht dein Wirkungskreis – Menschen, die bewusst wohnen, gestalten und
            investieren. Austausch, Inspiration und gemeinsames Wachstum in einem Raum.
          </p>
        </motion.header>
        ...
        >
          ...
          <div className="space-y-0.5">
            ...
            <p className="text-[12px] text-slate-600 dark:text-white/55 leading-snug">
              Wir bauen gerade die Community – damit du dich mit Gleichgesinnten austauschen,
              Erfahrungen teilen und gemeinsam wachsen kannst.
            </p>
          </div>
        </motion.div>
              ...
              >
                <div className="m-3 flex-1 rounded-xl border border-slate-200 dark:border-white/10 bg-slate-100/80 dark:bg-white/5 px-4 py-3 flex flex-col justify-between">
                  ...
                  <div className="pointer-events-none absolute inset-3 flex items-center justify-center opacity-20">
                    <MessageCircle className="h-10 w-10 text-slate-400 dark:text-white/30" />
                  </div>
